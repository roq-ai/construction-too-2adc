...
import { getRentalTransactionById } from 'apiSdk/rental-transactions';
...
function RentalTransactionViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Transaction Detail View
          </Text>
          {hasAccess('rental_transaction', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-transactions/edit/${data?.id}`} passHref legacyBehavior>
              <Button
